...
def mine_block(block_number, transactions, previous_hash, difficulty):
    """
        Simulates mining a Bitcoin block by finding a nonce that results
            in a hash starting with 'difficulty' number of zeros.
                """
                    prefix_str = '0' * difficulty
                        nonce = 0

                                print(f"--- Starting Mining for Block {block_number} ---")
                                    print(f"Target: Hash must start with {difficulty} zeros ('{prefix_str}')")

                                            start_time = time.time()

                                                while True:
                                                        # 1. Prepare the data: combine block info with the changing nonce
                                                                text = str(block_number) + transactions + previous_hash + str(nonce)

                                                                                # 2. Calculate the hash (SHA-256)
                                                                                        hash_result = hashlib.sha256(text.encode()).hexdigest()

                                                                                                # 3. Check if the hash meets the target difficulty
                                                                                                                                                                                            ...
                                                                                                                                                                                            print(f"Time Taken: {time_taken:.4f} seconds")
                                                                                                                                                                                                        return hash_result
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        # 4. If not, increment nonce and try again
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                # --- Configuration ---
                                                                                                                                                                                                                                # You can change the difficulty to see how it gets harder.
                                                                                                                                                                                                                                # 4 is easy, 6 is hard, 7+ might take a long time on a standard PC.
                                                                                                                                                                                                                                DIFFICULTY_LEVEL = 4

                                                                                                                                                                                                                                # Dummy data simulating a previous block and transactions
                                                                                                                                                                                                                                last_hash = "0000000000000000000a6c6e7f8d9e0b1c2d3e4f5g6h7i8j9k0l1m2n3o4p"
                                                                                                                                                                                                                                block_data = "Alice pays Bob 5 BTC"

                                                                                                                                                                                                                                # Start the miner
                                                                                                                                                                                                                                if __name__ == "__main__":
                                                                                                                                                                                                                                    mine_block(1, block_data, last_hash, DIFFICULTY_LEVEL)import hashlib
                                                                                                                                                                                                                                    import time
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    print(f"Time Taken: {time_taken:.4f} seconds")
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                return hash_result
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                # 4. If not, increment nonce and try again
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        # Start the miner
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if __name__ == "__main__":
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            mine_block(1, block_data, last_hash, DIFFICULTY_LEVEL)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            import hashlib
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            import time
